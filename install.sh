#!/usr/bin/env sh
# Universal installer for piiscan. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/piiscan.git"
echo "Installing piiscan ..."
