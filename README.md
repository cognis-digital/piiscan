...
[![PyPI](https://img.shields.io/pypi/v/cognis-piiscan.svg)](https://pypi.org/project/cognis-piiscan/)
[![CI](https://github.com/cognis-digital/piiscan/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/piiscan/actions)
...
PIISCAN exists for one job — pii discovery across warehouses and lakes (data-side scanner) — and does it without a SaaS bill or heavyweight setup.
...
```bash
piiscan --version
piiscan scan .                      # scan the current project
piiscan scan . --format json
piiscan scan . --fail-on high       # non-zero exit for CI gates
piiscan mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **Presidio**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`piiscan` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
