"""PIISCAN core — PII discovery across warehouses and lakes (data-side scanner)."""
...
RULES = [
    ("PII-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("PII-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("PII-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
