"""PIISCAN command-line interface."""
from __future__ import annotations
import argparse, sys
from piiscan.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="piiscan", description="PIISCAN — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from piiscan.mcp_server import serve
        return serve()
    if args.cmd == "scan":
